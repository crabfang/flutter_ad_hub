...
- (instancetype)initWithSpaceID:(NSString *)spaceID spaceParam:(NSString *)spaceParam ADHUB_DEPRECATED_MSG_ATTRIBUTE("use initWithFrame:spaceID:spaceParam:lifeTime: instead.");
...
/*
 banner点击不喜欢
 */
- (void)ADH_bannerDislikeDidClick:(AdHubBannerView *)adHubBanner;
